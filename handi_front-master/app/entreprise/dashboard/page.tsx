...
function DashboardPage() {
  ...
  if (loading) {
    return (
      <div className="company-dashboard-loading">
        <div className="company-dashboard-spinner" />
  ...
  return (
    <section className="company-dashboard">
      ...
      {error ? <div className="company-dashboard-error">{error}</div> : null}
      ...
      <style jsx>{`
        ...
        .quick-action {
          ...
          background: linear-gradient(165deg, #f6f1fb 0%, #f2edf8 100%);
          border-radius: 14px;
          padding: 14px;
          display: flex;
          align-items: center;
        ...
        .quick-action.primary {
          color: #fff;
          border-color: #4f1886;
          background: linear-gradient(140deg, #2d0443 0%, #6d29c8 100%);
          box-shadow: 0 14px 26px rgba(53, 6, 62, 0.34);
        }
        ...
        .tip-panel {
          background: linear-gradient(160deg, #f2ebfc 0%, #efe8fa 100%);
          border-color: #e7ddf5;
        }
        ...
        .tip-panel a {
          ...
          padding: 0 18px;
          text-decoration: none;
          background: linear-gradient(140deg, #2c0442 0%, #5f23b4 100%);
          color: #fff;
          font-weight: 700;
          font-size: 0.92rem;
          box-shadow: 0 12px 24px rgba(53, 6, 62, 0.25);
        }
