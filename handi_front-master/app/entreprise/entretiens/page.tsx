...
export default function EntretiensEntreprisePage() {
  ...
  return (
    <div className="app-page interviews-dashboard">
      ...
      {loading ? (
        ...
        <Card padding="lg">
          <div className="empty-main">
            ...
            <p>Start by scheduling your first interview from Applications.</p>
            <Button onClick={ouvrirPlanification} disabled={candidaturesPlanifiables.length === 0}>
              Schedule interview
            </Button>
          </div>
          ...
          <section className="details-panel">
            ...
            {entretienSelectionne ? (
                ...
                return (
                  <>
                    ...
                    <div className="details-actions">
                      ...
                      <Button variant="danger" onClick={() => lancerAction(entretienSelectionne.entretien.id, "annuler")} disabled={actionEnCours}>
                        Cancel
                      </Button>
                    </div>
                    ...
                    {entretienEnEdition === entretienSelectionne.entretien.id ? (
                      <Card tone="accent" padding="lg">
                        <div className="form-section">
                          <div>
                            <strong style={{ fontSize: "1.05rem" }}>Reschedule interview</strong>
              ...
              <div className="empty-side">
                <p>Select an interview from the timeline to view details.</p>
              </div>
            )}
          </section>
        </div>
