...
export default function CandidaturesCompanyPage() {
  ...
  return (
    <div className="app-page applicants-dashboard">
      <div className="applicants-header">
        <div>
          <h1>Manage applicants</h1>
          <p>Review, filter and take action on all job applications.</p>
        </div>
                  ...
                  {pipelineColonnes.map((colonne) => {
                    ...
                    return (
                      <article key={colonne.key} className="pipeline-card">
                            ...
                            items.slice(0, 3).map((candidature) => (
                              ...
                              >
                                ...
                                <span className="candidate-copy">
                                  ...
                                  <small>Applied on {formaterDate(candidature.date_postulation)}</small>
                                </span>
                        ...
                        <footer>View all ({items.length})</footer>
                      </article>
                    );
                  })}
                </section>
              ...
              {candidaturesFiltrees.length === 0 ? (
                <Card padding="lg">
                  <div className="empty-core">
                    ...
                    <p>
                      {offreSelectionnee
                        ? `No applications match ${offreSelectionneeLabel}.`
                        ...
                        {candidaturesFiltrees.map((candidature) => {
                          ...
                          return (
                            <tr key={candidature.id}>
                              ...
                              <td>{candidature.candidat.experience || "0 year"}</td>
                              <td>{formaterDate(candidature.date_postulation)}</td>
                              <td>
      ...
      <style jsx>{`
        .applicants-dashboard {
          background: linear-gradient(180deg, #fbf8ff 0%, #f5f2fc 100%);
          padding: 8px;
          border-radius: 24px;
        }
        .applicants-header {
        ...
        .tip-card {
          background: linear-gradient(160deg, #efe2ff 0%, #f8f2ff 100%);
        }
        .tip-card h3 {
          margin: 0;
          color: #2a1843;
